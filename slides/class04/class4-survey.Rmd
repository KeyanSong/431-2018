---
title: "Exploring the Day 1 Survey"
...
day1 %>% 
    ...
    labs(x = "Price of Most Recent Haircut in $",
         ...
         subtitle = "431 students from 2014 - 2018")
```
...
Let's look at the 2018 data only, and fit a curved (loess) smooth to predict pulse rate on the basis of hours of sleep the prior night. We'll also add a title and subtitle and retitle the axes
...
We could instead restrict ourselves to a linear model for the 2018 group.
...
day1 %>%
    ...
    labs(title = "Pulse Rate as a Function of Hours of Sleep Last Night",
         subtitle = "with fitted linear model, students in the 2018 class",
         x = "Hours of Sleep Last Night",
         y = "Pulse Rate in Class Today")
```
...
day1 %>%
 ...
 #   geom_point() + 
    geom_smooth(method = "lm", se = FALSE) +
    labs(title = "Pulse Rate and Hours of Sleep, 2014-2018",
         x = "Hours of Sleep Last Night",
         y = "Pulse Rate in Class Today") +
	  theme_bw()
```
