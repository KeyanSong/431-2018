...
Visit \color{blue} http://bit.ly/431-2018-names \color{black} and give me your preferred name and email.
...
The sheet is at \color{blue} http://bit.ly/431-2018-day1-ageguess
...
```{r error_vs_true_age_2017_labeled, echo = FALSE}
ggplot(filter(ageguess, year == 2017), aes(x = true.age, y = error, fill = sex)) +
  ...
  theme(axis.text = element_text(size = 14),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 12, face = "bold")) +
  labs(title = "Errors in 2017 Age Guessing, by Subject's Sex",
...
1. Visit \color{blue} http://bit.ly/431-2018-names \color{black}: provide preferred name, email.
2. Follow the [\color{blue}{software instructions}](https://github.com/THOMASELOVE/431-2018/tree/master/software) to get R, R Studio, R Packages and 431 Data on your computer.
...
5. Read [\color{blue}{the syllabus}](https://thomaselove.github.io/2018-431-syllabus/) and look at the rest of [\color{blue}{the website}](https://github.com/THOMASELOVE/431-2018). Make sure you view the [\color{blue}{Course Notes}](https://thomaselove.github.io/2018-431-book/).
6. Ask us questions. TA office hours start next week, but email is available now.

- Course Web Site: \color{blue} https://github.com/THOMASELOVE/431-2018 \color{black}
