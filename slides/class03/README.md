...
- Today, we'll do some live coding. Useful files for that include:
    ...
    - An R Markdown file called [class3-pre.Rmd](https://raw.githubusercontent.com/THOMASELOVE/431-2018/master/slides/class03/class3-pre.Rmd) that is my pre-class version of what we'll do live, if you want to save some typing.
