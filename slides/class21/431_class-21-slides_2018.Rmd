...
The ANOVA table reports here on a single **factor** (behavior group) with 3 levels, and on the residual variation in health **outcomes** not accounted for by that factor.
...
- *n* observations and *g* groups yield $n - g - 1$ residual df in a one-factor ANOVA table.
