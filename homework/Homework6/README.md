...
Homework 6 is due at noon on Friday 2018-10-26. It contains nine questions. Please be sure to answer them all.

- Homework 6 [instructions are here](https://github.com/THOMASELOVE/431-2018/blob/master/homework/Homework6/431-2018-hw6.md).
...
1. Create a new directory called something like `431HW6`, specifically for this homework assignment.
2. Open R Studio, and create a new R Project in this existing `431HW6` directory. 
...
4. Knit the file in R Studio to create an HTML file, which should have your actual name in it, not something like `YOURNAME-hw6.html`
...
7. Submit your final R Markdown file and your final HTML file to us via [Canvas](https://canvas.case.edu), by the deadline, which again is noon Friday 2018-10-26.
...
- We'll post the Homework 6 answer sketch very shortly after the deadline. This is why we don't accept late work. 
